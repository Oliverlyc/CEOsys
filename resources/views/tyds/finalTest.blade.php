...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header" style="text-align:center;">{{ __('请填写信息') }}</div>
                    @if(Session::has('msg'))
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="{{ route('showFinalTestForm') }}">
                            @csrf
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <label class="modal-title" id="formModalLabel">{{__('是否确定参加作品验收？')}}</label>
                                                </div>
