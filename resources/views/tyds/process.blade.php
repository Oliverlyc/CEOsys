...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header" style="text-align:center;">{{ __('中期进度报告') }}</div>
                    @if(Session::has('msg'))
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="{{ route('showProcessForm') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="process" class="col-md-4 col-form-label text-md-right">{{__('进度报告')}}</label>
                                <div class="col-md-6">
                                    <textarea name="process" id="process"  class="processCount form-control" placeholder="200~300字"></textarea>
                                    <span class="processNum"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="problem" class="col-md-4 col-form-label text-md-right">{{__('遇到的问题')}}</label>
                                <div class="col-md-6">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <label class="modal-title" id="formModalLabel">{{__('是否确定提交信息呢~~')}}</label>
                                                </div>
